import pytest
from day4.solution import solve_part1, solve_part2

test_input_part1 = "day4/test_input.txt"
test_input_part2 = "day4/test_input.txt"  # Change if part 2 has different example
